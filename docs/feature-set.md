...
- Shared worktree provisioning that configures an isolated `APP_URL`, app database, companion testing database, app key, app/testing migrations, ignored generated PHPUnit test database wiring, cleanup restoration, and doctor check.
